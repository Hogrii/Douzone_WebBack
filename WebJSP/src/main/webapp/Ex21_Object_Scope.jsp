...
<%
	...
	emp.setEmpno(2000);
	emp.setEname("홍길동");	
	// emp 변수의 범위는 페이지로 한정된다
	
	session.setAttribute("empobj", emp);
	// emp 변수는 다른 페이지에서도 사용 가능
	...
	// include, forward된 페이지가 있다면 범위가 확장
	
	// bb.jsp(forward)
	String who = (String)request.getAttribute("who"); // request도 Object 타입이기 때문에 다운캐스팅 필수
	out.print(who + "<br>");
%>
<!DOCTYPE html>
<html>
