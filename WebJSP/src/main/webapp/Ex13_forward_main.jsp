...
/*  
	[요청에 대한 흐름 제어]
	1. include (공통 디자인) >> 공통 페이지를 만들고 추가 >> header, footer
	2. forward (중계자 : 경찰서 112상황실 통제권한) >> 자기코드가 없음 >> 논리제어
...
<!-- 
	forward를 가지고 있는 페이지는 아래에 있는 내용이 의미가 없음
	Buffer를 비우고 비워낸 Buffer에 forward된 페이지 내용을 담는다
 -->
<!DOCTYPE html>
<html>
<head>
