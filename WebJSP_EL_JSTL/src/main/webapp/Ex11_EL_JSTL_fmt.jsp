...
<body>
	...
	<br>
	<fmt:formatNumber value="50000000" type="currency" currencySymbol="$" /> <!-- 화폐단위 -->
	<br>
	<fmt:formatNumber value="0.13" type="percent" /> <!-- 백분율 -->
	변수에 설정
	<br>
	<fmt:formatNumber value="123456789" pattern="###,###,###" var="pdata" /> <!-- var : 변환결과를 담는 변수 -->
	변수에 설정한 값 : ${pdata}
	<br>
