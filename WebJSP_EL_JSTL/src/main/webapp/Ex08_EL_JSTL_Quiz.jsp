...
<%
	// list.do?id=jhlee&pwd=1004
	// list.do?id=jhlee&pwd=1004&hobby=농구&hobby=야구&hobby=당구
	
	// String[] hobbys = request.getParameterValues("hobby")
	
	// EL > ${param.id} ${param.pwd} ** ${paramValues.hobby} **

	// Ex08_EL_JSTL_Quiz.jsp?id=jhlee&pwd=1004&hobby=농구&hobby=야구&hobby=당구
%>
<!DOCTYPE html>
<html>
<head>
	...
	<c:choose>
		<c:when test="${!empty paramValues.hobby }">
			...
			<ul>
				...
				<!-- varStatus를 이용해서 index, count 등을 관리할 수 있다 -->
